...
import { MDBCard, MDBCardBody, MDBValidation, MDBBtn, MDBValidationItem, MDBInput, MDBTextArea } from 'mdb-react-ui-kit';
...
const AddEditTour = () => {
    ...
    const { error, errorMessage, userTours } = useSelector((state) => ({...state.tour}));
                    ...
                    <MDBValidation onSubmit={handleSubmit} className="row g-3" noValidate>
                        <div className='col-md-12'>
                            <MDBValidationItem invalid feedback="Please provide title">
                                <MDBInput placeholder='Enter Title' type="text" value={title} name="title" onChange={onInputChange} className="form-control" required />
                            </MDBValidationItem>
                        </div>
                        
                        <div className='col-md-12'>
                            <MDBValidationItem invalid feedback="Please provide description">
                                <MDBTextArea placeholder='Enter Description' type="text" value={description} name="description" onChange={onInputChange} className="form-control" rows={4} required />
                            </MDBValidationItem>
                        </div>
                        ...
                        <div className='col-md-12'>
                            ...
                            />
                            {tagErrorMsg && (
                                <div className="tagErrMsg">{tagErrorMsg}</div>
                            )}
                        </div>
